...
const CTA = () => {
  return (
    <section className="w-full bg-[#F9F9F9] text-center flex flex-col items-center py-16 lg:py-24 padding-x">
      ...
      <h2 className="text-[#111] font-bold text-[42px] sm:text-5xl md:text-[66px] leading-[1.25] tracking-[-0.02em] mb-7">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full mb-6">
        <button className="w-full sm:w-auto h-[60px] px-8 bg-[#fb1d10] hover:bg-[#e6170b] text-white font-bold text-[17px] rounded-xl flex items-center justify-center transition-colors duration-200">
          Book a Workflow Audit
        </button>
        <button className="w-full sm:w-auto h-[60px] px-8 bg-transparent border-2 border-[#fb1d10] text-[#fb1d10] hover:bg-[#fb1d10]/5 font-bold text-[17px] rounded-xl flex items-center justify-center transition-colors duration-200">
