  ...
  return (
    <section className="bg-[#fff] padding-x py-24 selection:bg-red-100 selection:text-red-900 overflow-hidden">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {/* card 1 */}
        <div className="flex flex-col items-start gap-3 px-5 lg:px-10 pt-6 lg:pt-10 pb-16 bg-[#EFF6FF] border-2 border-[#DBEAFE] rounded-[22px] relative overflow-hidden">
          <div
        ...
        {/* card 2 */}
        <div className="flex flex-col items-start gap-3 px-5 lg:px-10 pt-10 lg:pb-10 pb-16 bg-[#FAF5FF] border-2 border-[#F3E8FF] rounded-[22px] relative overflow-hidden">
          <div
        ...
        {/* card 3 */}
        <div className="flex flex-col items-start gap-3 px-5 lg:px-10 pt-6 lg:pt-10 pb-16 bg-[#FFF7ED] border-2 border-[#FFEDD4] rounded-[22px] relative overflow-hidden">
          <div
      ...
      <div className="w-full flex justify-center mt-8">
        <Link
          ...
          className="red-bg text-white rounded-[14px] w-auto px-5 lg:px-0 lg:w-[249px] h-[64px] text-sm md:text-lg font-semibold inline-flex items-center justify-center"
        >
