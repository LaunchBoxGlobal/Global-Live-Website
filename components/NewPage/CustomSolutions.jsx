    ...
    <section className="bg-[#fff] padding-x py-24 selection:bg-red-100 selection:text-red-900 overflow-hidden">
      ...
      <div className="bg-[#fff] flex flex-col items-center selection:bg-red-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          {/* Card 1 */}
          <div className="bg-white rounded-[28px] p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 flex flex-col">
        ...
        <div className="max-w-3xl mx-auto mt-8 text-center px-4">
          ...
          <button className="bg-[#fb1d10] hover:bg-[#e6170b] text-white font-medium py-4 px-8 rounded-lg shadow-sm transition-colors duration-200">
