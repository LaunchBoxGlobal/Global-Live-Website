...
export default function TrustedByOperators() {
  return (
    <div className="min-h-screen bg-[#fafafa] py-24 px-4 sm:px-6 lg:px-8 selection:bg-red-100 selection:text-red-900 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          ...
          <h2 className="text-4xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-[72px] font-bold text-[#111111] tracking-tighter leading-[40px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 md:gap-6 lg:gap-10 pb-12 md:pb-24 px-2 sm:px-4 lg:px-6 pt-6">
          {/* Card 1 */}
          <div className="relative bg-white border border-[#EAEAEA] custom-shadow rounded-[2rem] -rotate-3 p-8 xl:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between md:translate-y-0">
            <div className="absolute -top-3 -left-3 bg-[#ea2b2b] rounded-2xl p-4 shadow-[0_8px_20px_rgba(234,43,43,0.3)] w-[41px] h-[41px] -rotate-1">
          ...
          {/* Card 2 */}
          <div className="relative bg-white border border-[#EAEAEA] custom-shadow rounded-[2rem] rotate-1 p-8 xl:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between md:translate-y-12">
            <div className="absolute -top-3 -left-3 bg-[#ea2b2b] rounded-2xl p-4 shadow-[0_8px_20px_rgba(234,43,43,0.3)] w-[41px] h-[41px]">
          ...
          {/* Card 3 */}
          <div className="relative bg-white border border-[#EAEAEA] custom-shadow rounded-[2rem] -rotate-2 p-8 xl:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between md:translate-y-6">
            <div className="absolute -top-3 -left-3 bg-[#ea2b2b] rounded-2xl p-4 shadow-[0_8px_20px_rgba(234,43,43,0.3)] w-[41px] h-[41px] -rotate-2">
        ...
        <div className="text-center mt-12 md:mt-20">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mx-auto w-full">
