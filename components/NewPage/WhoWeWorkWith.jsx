  ...
  return (
    <section className="bg-[#fff] padding-x py-24 selection:bg-red-100 selection:text-red-900 overflow-hidden">
      ...
      <div className="mb-10 text-center">
        ...
        <p className="text-gray-400 font-light leading-[1.2] text-lg md:text-xl xl:text-2xl max-w-[75%] mx-auto mt-5">
      ...
      <div className="w-full grid gird grid-cols-2 md:grid-cols-4 lg:grid-cols-7 xl:grid-cols-7 gap-3">
        {services.map((ser) => {
          return (
            <div
              key={ser.title}
              className="w-full h-[142px] rounded-[15px] flex flex-col text-center items-center justify-center border border-[#E5E7EB] bg-white hover:bg-[#f40e00] transition-all duration-300 group p-4 gap-3 hover:text-white"
            >
      ...
      <div className="w-full flex flex-col items-center gap-7 mt-8">
        ...
        <Link
          href={"/contact-us"}
          className="red-bg text-white rounded-[10px] w-full md:w-[275px] h-[56px] flex items-center justify-center text-lg font-medium"
        >
          See If You Qualify
        </Link>
      </div>
