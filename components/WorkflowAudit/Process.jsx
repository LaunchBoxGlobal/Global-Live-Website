...
const PROCESS_STEPS = [
  {
    ...
    icon: "/workflow-audit/home/workflow-audit-icon.png",
    width: 26,
    height: 26,
  ...
  },
  {
    ...
    icon: "/workflow-audit/scope-and-proposal-icon.png",
    width: 18,
    height: 23,
  ...
  },
  {
    ...
    icon: "/workflow-audit/design-and-build-icon.png",
    width: 26,
    height: 26,
  ...
  },
  {
    ...
    icon: "/workflow-audit/launch-and-handoff-icon.png",
    width: 26,
    height: 26,
      ...
      <div className="w-full lg:max-w-[55%]">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          <button
            type="button"
            onClick={openModal}
            className="w-full min-h-[237px] flex flex-col items-start justify-between p-5 text-start rounded-[24px] bg-[#f40e00] transition-all duration-300 group"
          >
            <span className="text-[24px] leading-[1] lg:max-w-1/2 block font-bold text-white transition-all duration-300">
