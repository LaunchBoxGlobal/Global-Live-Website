      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12 md:mt-20">
          ...
          <div className="flex flex-wrap justify-center gap-3 mx-auto w-full">
            <IndustryTag icon={"/workflow-audit/HVAC.png"} label="HVAC" />
            <IndustryTag
              icon={"/workflow-audit/plumbing.png"}
              label="Plumbing"
            />
            <IndustryTag
              icon={"/workflow-audit/electrical.png"}
              label="Electrical"
            />
            <IndustryTag icon={"/workflow-audit/roofing.png"} label="Roofing" />
            <IndustryTag
              icon={"/workflow-audit/fleet-and-logistics.png"}
              label="Fleet & Logistics"
            />
            <IndustryTag
              icon={"/workflow-audit/cleaning.png"}
              label="Cleaning"
            />
            <IndustryTag icon={"/workflow-audit/telecom.png"} label="Telecom" />
            <IndustryTag
              icon={"/workflow-audit/construction.png"}
              label="Construction"
            />
            <IndustryTag
              icon={"/workflow-audit/landscaping.png"}
              label="Landscaping"
            />
          </div>
        </div>
