...
const Timeline = () => {
  return (
    <div className="w-full padding-x z-10">
      <div className="w-full z-10 bg-white flex flex-col lg:flex-row lg:items-center items-start justify-between tracking-tight lg:border lg:hover:border-[var(--jetezee-primary-color)] lg:hover:shadow-[0px_0px_34px_0px_#efd49d] transition-all duration-300 rounded-full md:px-6 min-h-[107px] my-20 jetezee-timeline-shadow gap-4">
        <div className="flex items-center gap-3 z-10 bg-white">
          <div className="min-w-[66px] h-[66px] bg-[var(--jetezee-primary-color)] rounded-full flex items-center justify-center">
            <Image
