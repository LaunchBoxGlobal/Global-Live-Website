  ...
  return (
    <section className={`w-full relative`}>
      <Swiper
        {...sliderSettings}
        modules={[Autoplay]}
        className="overflow-hidden h-[428px] w-full"
        style={{ width: "100%", height: "100%" }}
      >
        {My_Garage_Outlet_Solutions?.map((value, index) => {
            ...
            >
              <div
                ...
                className={`w-full min-h-[286px] rounded-[35px] custom-shadow p-8 flex flex-col items-start gap-3 justify-center transition-all duration-500 ${
                  isActive
                    ? "bg-[#02A553] text-white"
                    : "bg-white text-black hover:bg-[#02A553] hover:text-white"
                }`}
              >
                <div
