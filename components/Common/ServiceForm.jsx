    ...
    >
      <div className="w-full flex flex-col items-start gap-3 lg:gap-5">
        <div className="w-full">
          <label
            htmlFor="firstName"
            className="block text-sm font-normal text-gray-300"
          >
            Your Name
          </label>
          <input
            ...
            className="pb-2 pt-1 block w-full border-b border-gray-300 bg-transparent lg:text-lg outline-none"
          />
          <div className="w-full">
        ...
        <div className="w-full">
          <button
            type="submit"
            className="bg-[#F40E00] text-white w-full rounded-full h-[45px] text-sm lg:text-lg font-semibold hover:bg-[#F40E00] transition-all duration-300"
          >
