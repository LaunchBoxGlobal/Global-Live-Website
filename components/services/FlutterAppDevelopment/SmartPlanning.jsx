    ...
    <section className="w-full padding-x py-10 lg:py-20 lg:pb-60 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading w-full">
          How Our Flutter App Development Company Builds Your{" "}
          <span className="blueText"> Dream App</span>
        </h2>
...
const AnimatedLine = () => {
  ...
  return (
    <div
      ref={ref}
      className="absolute top-20 h-[2960px] left-[20%] w-[759px] hidden lg:block pb-40"
    >
      <svg
        width="759"
        height="2660"
...
const ProcessCard = ({ process, index }) => {
  return (
    ...
    >
      <h3 className="font-medium text-[26px] lg:text-[39px] text-[#5290F1] leading-[1]">
        {process?.title}
      </h3>
      ...
      >
        <div className="w-full h-full bg-[#5290F1] rounded-full flex items-center justify-center">
          <img
            src={process?.icon}
            alt={process?.title}
