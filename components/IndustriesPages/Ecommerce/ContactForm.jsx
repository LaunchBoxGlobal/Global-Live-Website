...
const ContactForm = ({ title, buttonTitle }) => {
      ...
      <div className="w-full mt-10 flex flex-col items-start gap-3 lg:gap-5">
        <div className="w-full">
          ...
          <input
            ...
            className="pb-2 pt-1 block w-full border-b border-gray-400 lg:text-lg outline-none bg-transparent "
          />
          <div className="w-full">
        ...
        <div className="w-full">
          ...
          <input
            ...
            className="pb-2 pt-1 block w-full border-b border-gray-400 bg-transparent  lg:text-lg outline-none"
          />
          <div className="w-full">
