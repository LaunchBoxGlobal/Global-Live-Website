...
import HealthcareProcessCard from "./HealthcareProcessCard";
...
const AnimatedLine = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[8%] right-[-9%] items-center justify-center hidden lg:flex">
        <img
      ...
      {/* <img
        src="/industries/healthcare/line-3.png"
        alt="process-line"
        width={679}
        height={2231}
