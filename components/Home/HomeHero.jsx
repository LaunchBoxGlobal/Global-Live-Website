...
const HomeHero = () => {
  ...
  return (
    <section className="w-full bg-white relative pt-36 flex flex-col items-center justify-start gap-0 h-full md:h-auto xl:h-[100vh] 2xl:h-auto  lg:gap-[25px] overflow-hidden">
