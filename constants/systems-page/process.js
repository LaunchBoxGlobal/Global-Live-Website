export const SYSTEMS_PROCESS_TIMELINE = [
  {
    icon: "/systems-page/process-step-1.png",
    num: "/systems-page/discovery-call-num.png",
    width: 56,
  ...
  {
    icon: "/systems-page/process-step-2.png",
    num: "/systems-page/scoping-and-proposal-num.png",
    width: 84,
  ...
  {
    icon: "/systems-page/process-step-3.png",
    num: "/systems-page/design-and-build-num.png",
    width: 83,
  ...
  {
    icon: "/systems-page/process-step-4.png",
    num: "/systems-page/launch-and-handoff-num.png",
    width: 90,
