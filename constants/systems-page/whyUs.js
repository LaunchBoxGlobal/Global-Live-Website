export const WHY_US = [
  {
    ...
    icon: "/systems-page/startup-speed-icon.png",
    width: 326,
    height: 75,
  },
  {
    ...
    icon: "/systems-page/full-team-icon.png",
    width: 326,
    height: 75,
  },
  {
    ...
    icon: "/systems-page/you-own-everything.png",
    width: 326,
    height: 75,
  },
  {
    ...
    icon: "/systems-page/products-not-just-features.png",
    width: 326,
    height: 75,
  },
  {
    ...
    icon: "/systems-page/clean-handoff.png",
    width: 326,
    height: 75,
  },
  {
    ...
    icon: "/systems-page/we-have-done-this-before.png",
    width: 326,
    height: 75,
  },
];
